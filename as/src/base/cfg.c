...
typedef enum {
	...
	CASE_NAMESPACE_SCAN_LDT_BUFF_MAX,
...
const cfg_opt NAMESPACE_OPTS[] = {
		...
		{ "scan-ldt-buff-max",				CASE_NAMESPACE_SCAN_LDT_BUFF_MAX },
	...
	while (fgets(iobuf, sizeof(iobuf), FD)) {
		...
		case NAMESPACE:
			...
			case CASE_NAMESPACE_LDT_PAGE_SIZE:
				...
				break;
			case CASE_NAMESPACE_SCAN_LDT_BUFF_MAX:
				ns->scan_ldt_buff_max = cfg_u32_no_checks(&line);
				break;
